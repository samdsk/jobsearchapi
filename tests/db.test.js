...
describe("insert a job details to db", () => {
  ...
  it.skip("should not change original job obj", async () => {
  ...
  it.skip("should contain additionalDetails such as searchDate, searchJobType, searchLocation and searchLanguage", async () => {
  ...
  it("should not add duplicate jobs to db", async () => {
    const time = new Date(Date.now());
