...
const options = {
    ...
    transports: [
        ...
        new winston.transports.File({
            dirname: "logs",
            filename: "/logs/combined_master.log",
        }),
        new winston.transports.File({
            filename: "/logs/app-error_master.log",
            dirname: "logs",
            level: "error",
            format: combine(errorFilter(), timestamp(), json()),
        }),
        new winston.transports.File({
            filename: "/logs/app-info_master.log",
            dirname: "logs",
            level: "info",
    ...
    exceptionHandlers: [
        new winston.transports.File({
            dirname: "logs",
            filename: "/logs/exception_master.log",
        }),
    ],
    rejectionHandlers: [
        new winston.transports.File({
            dirname: "logs",
            filename: "/logs/rejections_master.log",
        }),
    ],
};
