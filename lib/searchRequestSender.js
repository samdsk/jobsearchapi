...
class SearchRequestSender {
   ...
   */
  async sendJobSearchRequest(JobType, index = 0, optionalParams) {
    const location = optionalParams?.location || "Italia";
    const language = optionalParams?.language || "it_IT";
...
module.exports = SearchRequestSender;
